...
class Ui_taskMakingFrame(object):
    def setupUi(self, taskMakingFrame):
        ...
        self.expressionInput.setMinimumSize(QtCore.QSize(200, 0))
        font = QtGui.QFont()
        font.setFamily("Helvetica Neue")
        font.setPointSize(11)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 775, 391))
...
"border-color: rgb(255, 255, 242);")
        ...
        self.taskDescriptionInput.setStyleSheet("border-color: rgb(255, 255, 242)")
