...
class Ui_askLepPage(object):
    def setupUi(self, askLepPage):
        ...
        self.askLepWidgetFrame.setMinimumSize(QtCore.QSize(400, 800))
        ...
        self.gridLayout.addWidget(self.askLepWidgetFrame, 2, 2, 2, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 774, 554))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 818, 537))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 774, 564))
        ...
        self.gridLayout_2.addWidget(self.myNotesScrollArea, 0, 0, 1, 1)
