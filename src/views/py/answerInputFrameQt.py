...
class Ui_answerInputFrame(object):
    def setupUi(self, answerInputFrame):
        ...
        answerInputFrame.resize(828, 93)
        ...
        answerInputFrame.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.answerInputField.setMinimumSize(QtCore.QSize(500, 50))
        ...
        self.gridLayout.addWidget(self.ifValidLabel, 0, 3, 1, 1)
