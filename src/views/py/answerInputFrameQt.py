...
class Ui_answerInputFrame(object):
    def setupUi(self, answerInputFrame):
        ...
        self.answerInputField = QtWidgets.QTextEdit(answerInputFrame)
        ...
        font.setPointSize(12)
        self.answerInputField.setFont(font)
        self.answerInputField.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.answerInputField.setFrameShadow(QtWidgets.QFrame.Plain)
        self.answerInputField.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.answerInputField.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
    ...
    def retranslateUi(self, answerInputFrame):
        ...
        self.answerInputField.setPlaceholderText(_translate("answerInputFrame", "Write expression here"))
