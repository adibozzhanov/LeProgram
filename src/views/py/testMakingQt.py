...
"background-color: rgb(246, 247, 200);")
        self.taskMakingScrollArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 472, 216))
...
"selection-background-color: rgb(233, 234, 189);")
        ...
        self.gridLayout.addWidget(self.finishButton, 8, 3, 1, 1)
        self.addTaskButton = QtWidgets.QPushButton(testMakingPage)
        self.addTaskButton.setMinimumSize(QtCore.QSize(150, 0))
        font = QtGui.QFont()
        font.setFamily("Helvetica Neue")
        font.setPointSize(14)
        font.setBold(True)
...
"")
        ...
        self.gridLayout.addWidget(self.addTaskButton, 8, 2, 1, 1)
