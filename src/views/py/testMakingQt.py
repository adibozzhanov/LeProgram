...
class Ui_testMakingPage(object):
    def setupUi(self, testMakingPage):
        ...
        testMakingPage.resize(1036, 649)
...
"selection-background-color: rgb(233, 234, 189);")
        ...
        self.askLepButton.setMinimumSize(QtCore.QSize(100, 0))
...
"")
        ...
        self.gridLayout.addWidget(self.askLepButton, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.testNameInput, 4, 1, 1, 1)
        self.askLepInput = QtWidgets.QPlainTextEdit(testMakingPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.askLepInput.sizePolicy().hasHeightForWidth())
        self.askLepInput.setSizePolicy(sizePolicy)
        self.askLepInput.setMinimumSize(QtCore.QSize(0, 0))
        self.askLepInput.setMaximumSize(QtCore.QSize(16777215, 68))
        font = QtGui.QFont()
        font.setFamily("Helvetica Neue")
        font.setPointSize(12)
        self.askLepInput.setFont(font)
        self.askLepInput.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.askLepInput.setFrameShadow(QtWidgets.QFrame.Plain)
        self.askLepInput.setObjectName("askLepInput")
        self.gridLayout.addWidget(self.askLepInput, 1, 7, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.askLepWidgetFrame, 4, 7, 12, 1)
...
"background-color: rgb(246, 247, 200);")
        ...
        self.gridLayout.addWidget(self.taskMakingScrollArea, 15, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.testNameLabel, 1, 1, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.addTaskButton, 10, 3, 1, 1)
    ...
    def retranslateUi(self, testMakingPage):
        ...
        self.askLepInput.setPlaceholderText(_translate("testMakingPage", "Type expression for Ask Lep here"))
