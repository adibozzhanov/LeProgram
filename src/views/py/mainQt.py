...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../res/ui icons/home.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"selection-background-color: rgb(233, 234, 189);")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../res/ui icons/ask lep.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"selection-background-color: rgb(233, 234, 189);")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../res/ui icons/random q.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"selection-background-color: rgb(233, 234, 189);")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("../res/ui icons/new test.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"selection-background-color: rgb(233, 234, 189);")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../res/ui icons/user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
