...
"selection-background-color: rgb(233, 234, 189);")
        ...
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("ui/../../res/ui icons/new test.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
